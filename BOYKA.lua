...
sudo_users = {SUDO,1621696605,1507567842,1330590972,1044506670,1208165035}   
...
elseif tonumber(user_id) == tonumber(1330590972) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1507567842) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1621696605) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
...
--------------------------------------------------------------------------------------------------------------
if text == 'احمد' or  text == 'ماديسون' or  text == 'مبرمج السورس' then
Text = [[

[ مبرمج سورس الفا ♡ ](t.me/AAHMEED11)

]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == 'عمرو' or  text == 'جافا' or  text == 'مطور السورس' then
Text = [[

[ مالك سورس الفا ♡ ](t.me/Amr_Khaleid)
...
[ مطور سورس الفا ♡ ](t.me/Mazika178)

]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == 'احمد بندا' or  text == 'بندا' or  text == 'banda' then
Text = [[

[ مطور سورس الفا ♡ ](t.me/B_A_N_D_A_9)

]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == 'خرصاوي'  or  text == 'محمد' or  text == 'kharasawy' then
Text = [[

[ مطور سورس الفا ♡ ](t.me/xx_KHARSAWY_xx)
...
os.execute('wget https://raw.githubusercontent.com/adham170/ALFAA/master/BOYKA.lua')
...
if tonumber(result.id_) == tonumber(1507567842) then  
send(msg.chat_id_, msg.id_, " ♔✒ لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(result.id_) == tonumber(1621696605) then  
send(msg.chat_id_, msg.id_, " ♔✒ لا تسطيع حظر مطور السورس عام")
return false 
end
